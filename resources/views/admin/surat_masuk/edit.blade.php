...
@section('content')
    ...
    <div class="card mx-3 my-4">
        <div class="card-header">
            <h2 class="text-center mb-0">Form edit data pengajuan oleh Admin</h2>
        </div>
        <div class="card-body">

            <form action="{{ route('suratmasuk.update', $pengajuansurat->id) }}" method="POST"
                            ...
                            <div class="col-12">
                                <select id="select" name="jenis_pengajuan" class="custom-select" required="required">
                                    ...
                                    <option value="Surat Keterangan Orang Yang Sama"
                                        @if ($pengajuansurat->jenis_pengajuan == 'Surat Keterangan Orang Yang Sama') selected @endif>
                                    ...
                                    <option value="Surat Keterangan Selesai Penelitian"
                                        @if ($pengajuansurat->jenis_pengajuan == 'Surat Keterangan Selesai Penelitian') selected @endif>
