    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="container-fluid">
                <h1 class="mt-4 text-center">Data Pengajuan Surat</h1>
                                        ...
                                        <tbody>
                                            @foreach ($datapengajuan as $dp)
                                                <tr>
                                                    ...
                                                    <td>{{ $dp->nama_pengaju }}</td>
                                                    <td>{{ $dp->nik }}</td>
                                                    <td class="center-align">
                                                        <button class="btn btn-sm btn-info" data-bs-toggle="modal"
                                                            data-bs-target="#modalDetail"
                                                            data-tempat-lahir="{{ $dp->tempat_lahir }}"
                                                            data-tanggal-lahir="{{ $dp->tgl_lahir }}"
                                                            data-jenis-kelamin="{{ $dp->jenis_kelamin }}"
                                                            data-agama="{{ $dp->agama }}"
                                                            data-pekerjaan="{{ $dp->pekerjaan }}"
                                                            data-alamat="{{ $dp->alamat }}"
                                                            data-upload-surat-pengantar="{{ $dp->surat_pengantar ? asset('storage/' . $dp->surat_pengantar) : '#' }}"
                                                            data-upload-kk="{{ $dp->upload_kk ? asset('storage/' . $dp->upload_kk) : '#' }}"
                                                            data-upload-ktp="{{ $dp->upload_ktp ? asset('storage/' . $dp->upload_ktp) : '#' }}">
                                                            <i class=""></i> Detail
                                                        </button>
                                                    </td>

                                                    <td>{{ $dp->jenis_pengajuan }}</td>
                                                    <td class="center-align">
                                                        <a href="{{ route('datapengajuan.edit', $dp->id) }}"
                                                            class="btn btn-sm btn-warning">
                                                            <i class="fas fa-pen"></i>
                                                        </a>
                                                        <a href="{{ route('datapengajuan.hapus', $dp->id) }}"
                                                    ...
                                                    <td class="center-align">
                                                        <a href="#"
                                                            class="btn btn-success btn-custom-small">Diterima</a>
                                                        <a href="#"
                                                            class="btn btn-danger btn-custom-small">Ditolak</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p><a id="upload-kk" href="#" target="_blank">Lihat KK</a></p>

                        <p><strong>Upload KTP:</strong></p>
                        <p><a id="upload-ktp" href="#" target="_blank">Lihat KTP</a></p>
                    </div>
